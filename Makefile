...
build-all:
	...
	mkdir -p dist; \
	GOOS=linux GOARCH=amd64 go build -o dist/coachgpt-linux-amd64 .; \
	GOOS=linux GOARCH=arm64 go build -o dist/coachgpt-linux-arm64 .; \
	GOOS=darwin GOARCH=amd64 go build -o dist/coachgpt-darwin-amd64 .; \
	GOOS=darwin GOARCH=arm64 go build -o dist/coachgpt-darwin-arm64 .; \
	GOOS=windows GOARCH=amd64 go build -o dist/coachgpt-windows-amd64.exe .
